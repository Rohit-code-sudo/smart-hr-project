...
const CandidateKanban = () => {
  const [data, setData] = useState<CandidateData[]>([]); // State to store the fetched data
  ...
  const totalcandidate = data.length;
                ...
                <div className="bg-white p-2 rounded mb-2">
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center">
                      ...
                      <span className="badge bg-light hover:border-2 border-blue-100 rounded-pill d-flex align-items-center">{totalcandidate || "--" }</span>
                    </div>
                    <div className="dropdown">
                      <Link
                        to="#"
                          ...
                          <div className="card-body">
                            ...
                            <div className="d-flex align-items-center flex-shrink-0 mb-3">
                              ...
                              >
                                ...
                                <img
                                  src="assets/img/users/user-39.jpg" // You can dynamically set this
                                  alt="Candidate"
                            ...
                            {/* Candidate Role and Applied Date */}
